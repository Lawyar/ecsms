...
DrawRectangleController::DrawRectangleController(
    PhantomRectangleModel &rect_model, FieldModel &field_model,
    SelectionModel &select_model, VisualizationModel &vis_model)
    : _rect_model(rect_model), _field_model(field_model),
      _select_model(select_model), _vis_model(vis_model) {}
