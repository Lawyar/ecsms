...
public:
  ...
  /// файл не создатся.
  /// ПРЕДУПРЕЖЕДЕНИЕ: Последующая работа с удаленным файлом
...
protected:
  ...
  /// SQL-команды.
  /// \param query Строка в запросом. Аргументы в запросе обозначаются знаком
  ///              доллара с последующим номером аргумента, начиная с единицы.
