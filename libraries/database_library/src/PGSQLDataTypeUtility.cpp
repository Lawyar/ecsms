...
//------------------------------------------------------------------------------
/**
  Вспомогательный класс для конвертации внутренних типов данных во внешние и обратно
  При добавлении новых типов данных требуется менять только конструктор,
...
private:
	...
	const std::vector<IdMatch> m_idMatches; ///< Список соответствий между внутренним и внешним типами данных
	const SQLDataTypeToOidMap m_SQLDataTypeToOidMap; ///< Мапа соответствий внутренних типов данных к внешним
	const OidToSQLDataTypeMap m_oidToSQLDataTypeMap; ///< Мапа соответствий внешних типов данных к внутренним
...
static const TypeConverter Converter; ///< Конвертер внешних типов данных во внутренние и обратно
