...
*/
//---
PGSQLTypeInteger::PGSQLTypeInteger(int value) : m_value(value) {}
...
*/
//---
std::optional<int> PGSQLTypeInteger::GetValue() const { return m_value; }
...
*/
//---
void PGSQLTypeInteger::SetValue(int value) { m_value = value; }
