...
*/
//---
template <> IDatabaseManager &GetDatabaseManager<DatabaseType::PostgreSQL>() {
...
//---
IConnectionPtr
PGDatabaseManager::GetConnection(const std::string &connectionInfo) {
...
//---
IExecutorEAVPtr
PGDatabaseManager::GetExecutorEAV(const IConnectionPtr &connection) {
