...
bool IsSQLKeyword(const std::string &sourceStr) {
  assert(sqlKeywords.size() ==
         841); // Проверка на то, что я правильно скопировал ключевые слова
  return sqlKeywords.find(utils::string::ToUpper(sourceStr)) !=
         sqlKeywords.end();
}
