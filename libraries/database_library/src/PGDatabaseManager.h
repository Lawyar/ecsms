...
/**
  ...
  программы несколько соединений, затем их использовать, а не создавать каждый
  раз заново. Когда из пула забирают соединение - асинхронно добавлять в него
  новое соединение).
*/
//---
...
public:
  ...
  GetConnection(const std::string &connectionInfo) override;

  /// Получить исполнитель EAV-запросов
  virtual IExecutorEAVPtr
  GetExecutorEAV(const IConnectionPtr &connection) override;
